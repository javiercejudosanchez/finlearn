      ...
      >
        ...
        <div className="mt-6 grid gap-3">
          {exercise.options.map((option) => {
            let borderColor = "border-gray-200 hover:border-orange-300";
            if (selectedOption === option.id && !showExplanation) {
              ...
              borderColor = "border-orange-400 bg-orange-100";
        ...
        {!showExplanation ? (
          ...
          <div
            className={`rounded-xl p-4 ${
              lastAnswerCorrect ? "bg-orange-100" : "bg-red-100"
            }`}
          >
            <p className={`font-bold ${lastAnswerCorrect ? "text-orange-600" : "text-red-700"}`}>
