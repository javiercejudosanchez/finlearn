...
export default function LearnPage() {
  ...
  const handleLessonClick = (lessonId: string) => {
    ...
    // Find the lesson to check if it uses phases
    ...
    // Legacy routing for lessons without phases
          ...
          >
            ...
            <div className="flex flex-col items-center">
              {unit.lessons.map((lesson, lessonIndex) => {
                ...
                const lessonHasPhases = hasPhases(lesson as unknown as LessonContent);
                ...
                return (
                  <div key={lesson.id} className="flex w-full flex-col items-center">
                    ...
                    >
                      ...
                      ) : status !== LessonStatus.LOCKED && !lessonHasPhases && !theoryCompleted ? (
                        <div className="absolute -top-2 -right-2 z-10 flex h-5 w-5 items-center justify-center rounded-full bg-blue-500 text-xs text-white shadow">
                          📖
                        </div>
                      ) : null}
